                        ...
                        <div class="card">
                            <form method="POST" action="<?php echo base_url().'Project/update'; ?>">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Master Project</h3>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="control-label">Kode Project</label>
                                        <input type="text" name="kode" value="<?php echo $edit['kode'] ?>" autocomplete="off" class="form-control" placeholder="Kode Project" required style="text-transform: uppercase;" id="kode">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Nama Project</label>
                                        <input type="text" name="nama" autocomplete="off" value="<?php echo $edit['nama'] ?>" class="form-control" placeholder="Nama Project" required style="text-transform: capitalize;" id="nama">
                                    </div>
                                    <!-- <div class="form-group"> -->
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?php echo base_url().'Project'; ?>" class="btn btn-default float-right"><i class="fas fa-times"></i> Batal</a>
                                </div>
                            </form>
                        </div>
                    </div>
