        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card">
                            <form method="POST" action="<?php echo base_url().'Satuan/insert'; ?>">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode" autocomplete="off" class="form-control" placeholder="Kode Satuan" required style="text-transform: uppercase;" id="kode">
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Nama satuan</label>
                                        <input type="text" name="nama" autocomplete="off" class="form-control" placeholder="Nama Satuan" required style="text-transform: capitalize;" id="nama">
                                    </div>
                                </div>
