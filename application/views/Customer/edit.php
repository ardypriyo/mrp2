                            ...
                            <div class="card">
                                <form method="POST" action="<?php echo base_url().'Customer/update'; ?>">
                                    <div class="card-header">
                                        <h3 class="card-title">Edit Master Customer</h3>
                                    </div>

                                    <div class="card-body">
                                        <div class="form-group">
                                            <label class="control-label">Kode Customer</label>
                                            <input type="text" name="kode" value="<?php echo $edit['kode']; ?>" class="form-control" maxlength="25" required autocomplete="off" style="text-transform: uppercase;">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Nama Customer</label>
                                            <input type="text" name="nama" value="<?php echo $edit['nama']; ?>" class="form-control" maxlength="255" required autocomplete="off" style="text-transform: capitalize;">
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label">Id</label>
                                            <input type="text" name="id" class="form-control" value="<?php echo $edit['id']; ?>" readonly>
                                        </div>
                                    </div>
